package avid.video.games.config.timezone;

import avid.video.games.AvidApp;
import avid.video.games.repository.timezone.DateTimeWrapper;
import avid.video.games.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM blog_date_time_wrapper where id=%d", fieldName, id);
    }
